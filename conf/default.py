...
CMDB_HOST = "http://localhost:8080"
CMDB_MONGO_PASS = '6278ed29-b141-496e-8dfa-d5d18063ca9c'
CMDB_MONGO_HOST = '192.168.165.53'
CMDB_MONGO_PORT = '27017'
CMDB_MONGO_USER = 'bk_cmdb'
CMDB_MONGO_DATABASES = 'cmdb'

MONGO_ENV = 'local'
MONGO_DATABASES = {
    'default': {
        'NAME': CMDB_MONGO_DATABASES,
        'USER': CMDB_MONGO_USER,
        'PASSWORD': CMDB_MONGO_PASS,
        'HOST': CMDB_MONGO_HOST,
        'PORT': CMDB_MONGO_PORT,
    },
    'local': {
        'NAME': 'cmdb',
        'USER': 'cc',
